package com.janita.caffeinecache;
...
public class MybatisCodeGenerate {
    // -custom
    private static String[] tableNames = new String[]{"person"};
    // 程序会自动找到basePath
    private static String basePath = null;

    private static Logger log = LoggerFactory.getLogger(MybatisCodeGenerate.class);

    private static final String DAO_PACKAGE = "com.janita.caffeinecache.dao" ;
    ...
    public void codegenForOneTable(String oneTableName) throws Exception {
        ...
        String schema = "cachetest";
        String fileCharset = "utf-8";
        String modalPackage = "com.janita.caffeinecache.bean";
        String daoPackage = "com.janita.caffeinecache.dao";
